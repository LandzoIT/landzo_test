 ...
 * Custom blocks
 */
//% weight=100 color=#0fbc11 icon="L" block="TianShu Extension Module"
namespace LANDZO_TS {
    ...
    //% blockId="MAX7219_show_point" block="Lattice_Led Display |Line %r|Row %l|Static %s|"
    ...
    //% blockId="MAX7219_show_line" block="Lattice_Led Display Line l %l|n %n" icon="\uf00a"
    ...
    */
    //% blockId="RGB" block="RGB_Led |Red%r|Green%g|Blue%b"
    //% weight=90 blockGap=8
    //% r.min=0 r.max=1
    //% g.min=0 g.max=1
    //% b.min=0 b.max=1
    ...
    //% blockId="Digital_Tube_Off" block="Digital_Tube"
    //% weight=90 blockGap=8
    export function SMG_Off() :void {
        write_byte0(0x69);
    }
    
    //% blockId="SMG" block="Digital_Tube_Dispaly %r"
    //% weight=90 blockGap=8
    export function SMG(num: number) :void {
        write_byte2(0x70, num&0xff, num>>8);
    }
    
    //% blockId="GPIO_Read_Analog" block="|%io|GPIO_ReadAnalog"
    //% weight=50
    ...
    //% blockId="GPIO_Read_Digital" block="|%io|GPIO_ReadDigital"
    //% weight=50
    ...
    //% blockId="GPIO_Write_Digital" block="|%io|GPIO_WriteDigital|%d|"
    //% weight=50
    ...
    */
    ...
    //% blockId="DS18B20_read" block="Temperature_Sensor"
    //% weight=50
    ...
    //% blockId="DHT11_read_temperature" block="DHT11_Temperature"
    //% weight=50
    ...
    //% blockId="DHT11_read_humidity" block="DHT11_HumiditySenso"
    //% weight=50
    ...
    //% blockId="Ultrasonic_read" block="Ultrasonic_Distance"
    //% weight=50
    ...
    //% blockId="BlackTraker_left" block="Infrared_Trace_1"
    //% weight=50
    ...
    //% blockId="BlackTraker_right" block="Infrared_Trace_2"
    //% weight=50
    ...
    //% blockId="Key_read" block="Read_Key_Static"
    //% weight=50
    ...
    //% blockId=landzobit_servo block="Steer|%index|Degree %degree"
    //% weight=100
    ...
    //% blockId=landzobit_stop block="Stop_Motor|%index|"
    //% weight=80
    export function MotorStop(index: Motors): void {
        MotorRun(index, 0);
    }

    //% blockId=landzobit_stop_all block="Stop All Motor"
    //% weight=79
    //% blockGap=50
